...
<div id="page-contactez-moi" class="content-page">
            ...
            <div class="container-informations-contact">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-5 col-informations-contact">
                        ...
                        <h3 class="title-horaire">Horaires</h3>
                    ...
                    <div class="col-12 col-lg-6 offset-lg-1 col-form">
                        <div class="container-form">
                            <div class="form">
                                <svg class="plante plante-form" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 86.47 169.16">
    ...
    <section id="map-section" class="container-fluid section">
